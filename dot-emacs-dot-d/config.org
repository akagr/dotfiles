...
** Mark parent todo done when completing children
#+BEGIN_SRC emacs-lisp
...
*** Ibuffer VC project integration
#+BEGIN_SRC emacs-lisp
...
** Auto fill file name when copying or renaming
#+BEGIN_SRC emacs-lisp
...
Flycheck is the most popular linter/checker for code and helps interface with cli tools.
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
** Execute shell command on region if present
#+BEGIN_SRC emacs-lisp
