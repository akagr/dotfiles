...
#+BEGIN_SRC emacs-lisp :results silent
  (aa/leader-key-def
    ...
    "co" '((lambda () (interactive) (find-file "~/.emacs.d/settings.org")) :which-key "open emacs config")
    "cc" '((lambda () (interactive) (load-file user-init-file)) :which-key "reload emacs config")
...
#+BEGIN_SRC emacs-lisp :results silent
  (use-package evil-collection
    :init
    (evil-collection-init '(deadgrep magit ibuffer)))
#+END_SRC
